...
logical bounds, visual bounds, the source-text range, and the glyph range for that line.
...
instance, `SizePixels`, run-level `TextDecorations`, logical bounds, visual bounds, and touched
line range used for layout.
