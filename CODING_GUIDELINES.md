...
- **Core Namespace**: `Forme` for all platform-independent font processing types
- **MonoGame Namespace**: `Forme.MonoGame` for all MonoGame-specific rendering types
